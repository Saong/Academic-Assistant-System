...
<body>
 ...
 <div class="formbody">
    ...
    <li>
	  ...
	  sturs.next();
	  out.println("<tr>");
	  out.println("<td colspan = '6' align='center' bgcolor=#f0f0f0> 团队成员 </td>");
	  out.println("<tr>");
    ...
    <a class="newbtn" style="margin-top:500px;margin-left:0" href="SSetProgress2.jsp?id=<%=srtpid%>">通过审批</a>
    </div>
