...
public class UploadServlet6 extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            String sql = "UPDATE teachreserch SET final_file = '"+desc.toString()+str+"' WHERE teachreserch_id="+srtpid;
        ...
        request.getRequestDispatcher("/TApply.jsp").forward(request, response);
    }
